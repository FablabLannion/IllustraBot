...
void protocol_process()
{
		...
		while(ptr_rd_buffer_spi != ptr_wr_buffer_spi) 
		{
		// Saturation buffer alarm
		//if(ptr_wr_buffer_spi > ptr_rd_buffer_spi) diff_buffer=ptr_wr_buffer_spi-ptr_rd_buffer_spi;
		//else diff_buffer=TAILLE_BUFFER_SPI-(ptr_rd_buffer_spi-ptr_wr_buffer_spi);
		//if (diff_buffer>=TAILLE_BUFFER_SPI-20) digitalWrite(8, HIGH);
		//else digitalWrite(8, LOW);
			...
			if(ptr_rd_buffer_spi == TAILLE_BUFFER_SPI) ptr_rd_buffer_spi = 0;
			else ptr_rd_buffer_spi++;			
